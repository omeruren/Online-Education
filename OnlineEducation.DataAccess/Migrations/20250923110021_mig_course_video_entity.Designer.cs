...
namespace OnlineEducation.DataAccess.Migrations
{
    ...
    [Migration("20250923110021_mig_course_video_entity")]
    partial class mig_course_video_entity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineEducation.Entity.Entities.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineEducation.Entity.Entities.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineEducation.Entity.Entities.CourseRegister", b =>
                {
            ...
            modelBuilder.Entity("OnlineEducation.Entity.Entities.CourseVideo", b =>
                {
            ...
            modelBuilder.Entity("OnlineEducation.Entity.Entities.TeacherSocial", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("OnlineEducation.Entity.Entities.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("OnlineEducation.Entity.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineEducation.Entity.Entities.Blog", b =>
                {
                    ...
                    b.HasOne("OnlineEducation.Entity.Entities.AppUser", "Writer")
                        .WithMany("Blogs")
            ...
            modelBuilder.Entity("OnlineEducation.Entity.Entities.Course", b =>
                {
                    b.HasOne("OnlineEducation.Entity.Entities.AppUser", "AppUser")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("OnlineEducation.Entity.Entities.CourseRegister", b =>
                {
                    ...
                    b.HasOne("OnlineEducation.Entity.Entities.Course", "Course")
                        .WithMany("CourseRegisters")
            ...
            modelBuilder.Entity("OnlineEducation.Entity.Entities.TeacherSocial", b =>
                {
                    b.HasOne("OnlineEducation.Entity.Entities.AppUser", "Teacher")
